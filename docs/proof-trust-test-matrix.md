...
| 212 | Multi-step drained permanence and "stopped stays quiescent" are now unblocked by claim 210/211 but are not yet proven; they build a Frozen bundle invariant on top and are the next slice | DOCUMENTED | RFC 089, `docs/resource-drain.md` | — | — |
